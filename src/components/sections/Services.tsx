  ...
  return (
    <section className="py-24 bg-light-bg" id="services">
      <div className="container mx-auto px-4">
        ...
        {(section.bottomDescription || section.buttonText) && (
          <div className="text-center mt-12 mb-16">
            ...
            {section.buttonText && (
              <button className="px-10 py-5 bg-primary text-white rounded-full font-bold text-sm tracking-widest uppercase hover:brightness-110 transition-all flex items-center gap-3 shadow-2xl shadow-primary/30 mx-auto group">
                {section.buttonText} <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center group-hover:bg-white group-hover:text-primary transition-all"><ArrowRight size={18} /></div>
              </button>
            )}
          </div>
        )}
